...
save(shooting_data_wrangled_pre_map, file = here("www", "data", "wrangled",
                             "shooting_data_wrangled_pre_map.rda"))

readr::write_csv(shooting_data_wrangled_pre_map, 
                 file = here("www", "data", "wrangled",
...
```{r, echo=FALSE}
load(file = here("www", "data", "wrangled",
                             "shooting_data_wrangled_pre_map.rda"))
```
...
```{r, eval = FALSE}
shooting_data <- 
  read_csv(here("www", "data", "wrangled",
                "shooting_data_wrangled_pre_map.csv"))
